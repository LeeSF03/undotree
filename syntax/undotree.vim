...
execute "syn match UndotreeBranch '[".escape(g:undotree_TreeHortShape.g:undotree_TreeVertShape.g:undotree_TreeVertSplitShape.g:undotree_TreeVertReturnShape.g:undotree_TreeSplitShape.g:undotree_TreeReturnShape,'\')."]'"
